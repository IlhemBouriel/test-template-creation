...
var ConfPlanComponent = (function () {
    function ConfPlanComponent() {
    }
    ConfPlanComponent.prototype.ngOnInit = function () {
    };
    ConfPlanComponent.prototype.sendFile = function (event) {
        console.log('here');
        console.log(event);
    };
...
//# sourceMappingURL=new-conf.component.js.map